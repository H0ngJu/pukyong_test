...
export default function Result() {
  ...
  return (
    <div className="result">
      <ResultImg url="https://www.pknu.ac.kr/upload/raonkeditordata/2022/08/18/20220818_102114958_35803.png" />
      <Count content="15" />
      <SubResultTitle content="선배미 뿜뿜" />
      <ResultTitle content="부경대 지킴이" />
      <Discription
        content_1="선배포스가 느껴지는 당신!"
        content_2="이대로 부경대 고인물까지 가보자고~"
      />
