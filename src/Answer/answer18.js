  ...
  return (
    <div className="App" style={{ height: "113vh" }}>
      ...
      <div
        ...
        style={{ top: "3vh", fontSize: "18px", lineHeight: "31px" }}
      >
        학부생은 최대 5권을 10일까지 대출할 수 있고, 2회 연장할 수 있습니다!
        연장 시 대출기간만큼 반납예정일이 증가합니다. <br />( 단, 반납예정일이
        지났거나 연체도서가 있는 경우, 다른 이용자가 자료를 예약한 경우에는
        연장이 불가능합니다. )
      </div>

      <div
        className="Ans normal"
        style={{ top: "7vh", fontSize: "18px", lineHeight: "31px" }}
      >
        참고로 현재 중앙도서관은 리모델링으로 인해 6월 30일까지 자료실 및 열람실
        사용이 불가능하고, 도서 대출도 폐가제로 변경되었습니다. <br />
