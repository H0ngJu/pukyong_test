    ...
    return(
        <div className="App">
            ...
            <div className="Ans bold" style={{
                 top: '10vh', width: '370px', left: 'calc(50% - 370px/2)',
                 fontSize: '20px'
            }}>
            ...
            <div className="Ans bold" style={{
                top: '25vh', width: '340px', left: 'calc(50% - 340px/2)',
                fontSize: '20px'
            }}>
                18 + 1 + 2 = 21<br/>
                따라서 백경이는 이번 학기에 최대<br/>
                21학점까지 수강이 가능합니다!<br/>
            </div>

            <div className="Ans normal" style={{
                top: '35vh', fontSize: '18px', width: '330px', left: 'calc(50% - 330px/2)'
            }}>
